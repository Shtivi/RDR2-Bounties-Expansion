	...
	: BaseMissionExecutor(missionData, areasMgr)
{
	...
	campfirePos = toVector3(1382.377, -2081.04, 50.99044);
...
void WallaceKnoxExecutor::prepareSet()
{
	...
	addHorse(horse);
	addHorse("A_C_Horse_KentuckySaddle_Black", toVector3(1391.582, -2090.708, 50.88281));
	addHorse("A_C_Horse_KentuckySaddle_SilverBay", toVector3(1395.158, -2089.237, 51.05108));

	// Now just add the enemies to the group to make them be controlled by it
	RoutineParams routine1;
	routine1.patrolName = "miss_hello9";
	routine1.patrolRoute.push_back(toVector3(1370.42, -2078.69, 51.9347));
	routine1.patrolHeading.push_back(toVector3(1369.98, -2079.22, 52.0415));
	routine1.patrolRoute.push_back(toVector3(1381.91, -2092.32, 51.897));
	routine1.patrolHeading.push_back(toVector3(1382.51, -2092.55, 51.8429));
	routine1.patrolRoute.push_back(toVector3(1394.99, -2082.84, 52.256));
	routine1.patrolHeading.push_back(toVector3(1395.39, -2081.56, 52.2525));
	routine1.patrolRoute.push_back(toVector3(1386.24, -2070.46, 52.7299));
...
Ped WallaceKnoxExecutor::spawnTarget()
{
	...
	this->horse = createPed("A_C_Horse_KentuckySaddle_Grey", toVector3(1388.549, -2091.956, 50.721));
	routine3.Horse = horse;
	routine3.isTarget = true;
	Vector3 targetPos = toVector3(1391.277, -2082.894, 51.65589);
